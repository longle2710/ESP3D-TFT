...
/**
 * @brief ESP32_ROTRICS_DEXARM35 SD SDIO GPIO definition
 *
 */
...
#define ESP3D_SDIO_CMD_PIN (40)  // GPIO 38
#define ESP3D_SDIO_CLK_PIN (38)  // GPIO 39
#define ESP3D_SDIO_D0_PIN (39)   // GPIO 40
#define ESP3D_SDIO_D1_PIN (41)   // NC
#define ESP3D_SDIO_D2_PIN (48)   // NC
#define ESP3D_SDIO_D3_PIN (47)   // NC

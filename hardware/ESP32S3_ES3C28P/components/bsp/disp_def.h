...
esp_spi_ili9341_config_t display_spi_ili9341_cfg = {
    .panel_dev_config = {.reset_gpio_num = -1,  // GPIO 4
    ...
    .spi_bus_config =
        {
            ...
            .pin_miso = 13,                       /**< MISO pin number */
            .pin_mosi = 11,                       /**< MOSI pin number */
    ...
    .disp_spi_cfg =
        {.dc_gpio_num = 46, /*!< GPIO used to select the D/C line, set this to -1
                              if the D/C line is not used */
         .cs_gpio_num = 10, /*!< GPIO used for CS line */
